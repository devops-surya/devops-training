# If came a across a scenario of creating multiple subnets:
1. First case :
...
* FOr coutn [REFER HERE](https://www.terraform.io/intro/examples/count.html)
* FOr count.index [REFER HERE](https://www.terraform.io/docs/configuration-0-11/interpolation.html)
* The main.ts and vars.tf look like below in the second case:
```
provider "aws" {
  region     = "us-east-2"
